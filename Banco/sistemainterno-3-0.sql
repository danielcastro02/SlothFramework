...
--
-- Host: localhost
-- Tempo de geração: 18-Jan-2020 às 22:37
...
CREATE TABLE `versao` (
  ...
  `update_sql` varchar(250) NOT NULL,
  `full_sql` varchar(250) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
ALTER TABLE `versao`
  ...
  ADD KEY `id_anterior` (`id_anterior`);
...
--
ALTER TABLE `versao`
  MODIFY `id_versao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
ALTER TABLE `versao`
  ...
  ADD CONSTRAINT `versao_ibfk_2` FOREIGN KEY (`id_anterior`) REFERENCES `versao` (`id_versao`);
COMMIT;
